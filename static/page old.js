...
module.exports = function (req, res, url) {
	...
	switch (url.pathname) {
		case '/studio': {
			...
			title = 'GoAnimate Retro And GoAnimators - Create Video - GoAnimate Retro';
			attrs = { 
			...
			params = {
				flashvars: {
					'apiserver': '/', 'storePath': 'https://josephcrosmanplays532.github.io/store/50/<store>', 'isEmbed': 1, 'ctc': 'go',
					...
					'tlang': 'en_US', 'presaveId': presave, 'goteam_draft_only': 1, 'isWide': 1, 'nextUrl': '/dashboard/videos',
				},
		...
		case '/go_full': {
			let presave = query.movieId && query.movieId.startsWith('m') ? query.movieId :
				`m-${fUtil[query.Autosave ? 'getNextFileId' : 'fillNextFileId']('movie-', '.xml')}`;
			title = 'GoAnimate Retro Light And GoAnimators - Create Video - GoAnimate Retro Light';
			attrs = { 
				data: 'https://josephcrosmanplays532.github.io/animation/503/go_full.swf',
				type: 'application/x-shockwave-flash', width: '100%', height: '100%',
			};
			params = {
				flashvars: {
					...
					'animationPath': 'https:\/\/josephcrosmanplays532.github.io\/animation\/503\/', 'userId': '0DyHqK6Yj9dM', 
					'username': 'good bois', 'uemail': 'crazy suitcase', 'numContact': '0', 'ut': 23, 've': false, 'isEmbed': 0, 
					'nextUrl': '\/movie\/0\/1\/?movieId=<movieId>', 
					'bgload': 'https:\/\/josephcrosmanplays532.github.io\/animation\/857\/go_full.swf', 'lid': '13', 'ctc': 'go', 
					'themeColor': 'silver', 'tlang': 'en_US', 'siteId': '13', 'templateshow': 'false', 'forceshow': 'false', 'appCode': 
					'go', 'lang': 'en', 'tmcc': '192', 'fb_app_url': '\/', 'is_published': '1', 'is_private_shared': '0', 'upl': 1, 
					'role': 'student', 'hb': '1', 'pts': '0', 'msg_index': '', 'ad': 0, 'has_asset_bg': 0, 'has_asset_char': 0, 
					'initcb': 'studioLoaded', 'retut': 0, 's3base': 'https:\/\/s3.amazonaws.com\/fs.goanimate.com\/', 'st': '', 'uisa': 0,
				...
				allowScriptAccess: 'always',
				movie: 'https://josephcrosmanplays532.github.io/animation/503/',
			};
			sessions.set({ movieId: presave }, req);
			break;
		}
    ...
    <div class="voice-vendor-ad" style="display: none;">
        ...
        <div id="studio-voice-vendor-container">
            <ul>
                ...
                <li><a class="gtm-ga-pageview-t2" id="voice-vendor-iw" target="_blank" href="https://www.inwhatlanguage.com/goanimate-translations/" data-gtmv-page="/pageTracker/voicebanner/InWhatLanguage" onclick="setvoicebannercookie();"><img src="https://josephcrosmanplays532.github.io/static/477/go/img/video_voice/btn_va.png"></a></li>
                <li>
                    <hr class="sperator">
...
<div style="display:none">
    ...
    <script>
        ...
        var studio_data = {
            id: "Studio",
            swf: "https://josephcrosmanplays532.github.io/animation/503/go_full.swf",
            width: "100%",
            height: "100%",
            align: "middle",
            allowScriptAccess: "always",
...
function loadLegacyPreview() {
    ...
    createPreviewPlayer("playerdiv", {
        ...
        utm_source: "", uid: "", isTemplate: "1", showButtons: "0", chain_mids: "", showshare: "0", averageRating: "",
                ...
                ratingCount: "", fb_app_url: "/", numContact: 0, isInitFromExternal: 1, storePath: "https://josephcrosmanplays532.github.io/store/3a981f5cb2739137/<store>", clientThemePath: "https://josephcrosmanplays532.github.io/static/019b83797158fc0c/<client_theme>", animationPath: "https://josephcrosmanplays532.github.io/animation/66453a3ba2cc5e1b/",
...
<div class="voice-vendor-ad" style="display: block; right: 0px;">
        ...
        <div id="studio-voice-vendor-container">
            <ul>
                <li><a class="gtm-ga-pageview-t2" id="voice-vendor-vb" target="_blank" href="https://voicebunny.com/?p=vyond" data-gtmv-page="/pageTracker/voicebanner/VoiceBunny" onclick="setvoicebannercookie();"><img src="https://josephcrosmanplays532.github.io/static/477/go/img/video_voice/btn_vb.png"></a></li>
                <li><a class="gtm-ga-pageview-t2" id="voice-vendor-iw" target="_blank" href="https://www.inwhatlanguage.com/goanimate-translations/" data-gtmv-page="/pageTracker/voicebanner/InWhatLanguage" onclick="setvoicebannercookie();"><img src="https://josephcrosmanplays532.github.io/static/477/go/img/video_voice/btn_va.png"></a></li>                <li>
                    <hr class="sperator">
                    <a class="voiceover-tips gtm-ga-pageview-t2" target="_blank" href="http://goanimate.com/video-maker-tips/tutorial-why-you-should-break-up-your-dialogue-audio-into-small-pieces-before-importing/" data-gtmv-page="/pageTracker/voicebanner/VoiceoverTips" onclick="setvoicebannercookie();"><span><i class="lightbulb"></i>Voiceover Tips &gt;</span></a>
                </li>
            </ul>
